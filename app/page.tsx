...
// FUNÇÃO AUXILIAR PARA PROCESSAR O EXCEL EM MEMÓRIA
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async (evt) => {
      try {
        ...
        // Envia o ficheiro bruto (XLSX) para a Vercel
        ...
        if (res.ok) {
          ...
          showToast(`Ficheiro guardado localmente (Erro ao sincronizar Cloud)`);
        }
      } catch (error) {
